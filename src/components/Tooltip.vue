...
function setTooltipPosition(el: HTMLElement, top: number, left: number) {
  el.style.top = `${top}px`
...
function isOutOfBounds(containerEl: HTMLElement) {
  ...
  return containerRect.left + width > viewportWidth || containerRect.left < 0 || containerRect.top < 0 || containerRect.top + height > viewportHeight
}
</script>
